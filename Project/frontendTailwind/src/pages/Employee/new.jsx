...
const EmployeeProfile = () => {
    ...
    const leaveCount = 14 - (res.data.leavesDetails.filter((leave) => leave.leaveStartDate.substring(0, 4) == thisYear).length);
                                    ...
                                    return (
                                        <div key={key}>
                                            ...
                                            <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                                                ...
                                                return(
                                                    <div className="text-md ml-12 pt-5">
                                                        <div className="p-1"> <span className="font-bold"> Basic salary </span> : {formatter.format(basic)}</div>
                                                        <div className="p-1"> <span className="font-bold"> Allowances </span> : {formatter.format(allowances)}</div>
                                                        <div className="p-1"> <span className="font-bold"> Incentives </span> : {formatter.format(incentives)}</div>
                                                        <div className="p-1"> <span className="font-bold"> Net Salary </span> : {formatter.format(total)}</div>
                                                    </div>
                                                )
                                                })}
                                            </div>
                                    ...
                                    <table className="w-full rounded-lg">
                                        ...
                                        {data.leavesDetails.filter((data3) => {
                                            if (startDate && endDate) {
                                                return data3.leaveStartDate >= startDate && data3.leaveStartDate <= endDate;
                                            }
                                            else {
                                                return data3;
                                            }
