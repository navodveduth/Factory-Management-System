                           ...
                           <div className='m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white '>
                                ...
                                <div className=" flex items-center justify-center">
                                    <form onSubmit={async(e)=>{
                                        ...
                                        await axios.put('http://localhost:8070/Production/order/updateStatus/'+updateOrder.invoiceNo,{"status":salesStatus}).then((res)=>{
                                        ...
                                        <div>
                                        <button type="submit" className="bg-red-800 text-lg text-white left-10 p-3 my-4 rounded-lg hover:bg-red-600">Approve Cost</button>
                                        </div>
                                    </form>
                                    </div>
                                </div>
